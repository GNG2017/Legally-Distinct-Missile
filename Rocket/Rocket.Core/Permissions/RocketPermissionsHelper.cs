...
namespace Rocket.Core.Permissions
{
    internal class RocketPermissionsHelper
    {
        ...
        public RocketPermissionsHelper(Asset<RocketPermissions> permissions) => this.permissions = permissions;

        public List<RocketPermissionsGroup> GetGroupsByIds(List<string> ids) =>
            permissions.Instance.Groups.OrderBy(x => x.Priority).Where(g => ids.Select(i => i.ToLower()).Contains(g.Id.ToLower())).ToList();
        ...
        internal RocketPermissionsGroup GetGroup(string groupId) =>
            permissions.Instance.Groups.OrderBy(x => x.Priority).FirstOrDefault(g => string.Equals(g.Id, groupId, StringComparison.CurrentCultureIgnoreCase));
